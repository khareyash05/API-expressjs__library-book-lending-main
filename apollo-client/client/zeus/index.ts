...
export type ValueTypes = {
	...
	["Query"]: AliasType<{
getUserById?: [{	id: string | Variable<any, string>},ValueTypes["User"]],
	getAllUsers?:ValueTypes["User"],
		__typename?: boolean | `@${string}`
}>;
	["CreateUserInput"]: {
...
export type ResolverInputTypes = {
	...
	["Query"]: AliasType<{
getUserById?: [{	id: string},ResolverInputTypes["User"]],
	getAllUsers?:ResolverInputTypes["User"],
		__typename?: boolean | `@${string}`
}>;
	["CreateUserInput"]: {
	name: string,
...
export type ModelTypes = {
	...
	["Query"]: {
		getUserById?: ModelTypes["User"] | undefined,
...
export type GraphQLTypes = {
	...
	["Query"]: {
	__typename: "Query",
	getUserById?: GraphQLTypes["User"] | undefined,
